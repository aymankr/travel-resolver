            ...
            <Table>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    {(
                      model.additional_metrics.travel_metrics.precision * 100
                    ).toFixed(2)}
                    %
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>
                    {(
                      model.additional_metrics.travel_metrics.recall * 100
                    ).toFixed(2)}
                    %
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>
                    {(model.additional_metrics.travel_metrics.f1 * 100).toFixed(
                      2
                    )}
                    %
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    {model.additional_metrics.travel_metrics.support}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
            ...
            <Table>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    {(
                      model.additional_metrics.non_travel_metrics.precision *
                      100
                    ).toFixed(2)}
                    %
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell>
                    {(
                      model.additional_metrics.non_travel_metrics.recall * 100
                    ).toFixed(2)}
                    %
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>
                    {(
                      model.additional_metrics.non_travel_metrics.f1 * 100
                    ).toFixed(2)}
                    %
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Support</TableCell>
                  <TableCell>
                    {model.additional_metrics.non_travel_metrics.support}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
